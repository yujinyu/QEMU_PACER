...
typedef void SaveSetParamsHandler(int blk_enable, int shared, int sparse, int fs_bsize, int compression, int scheduling, int dscheduling, int throttling,void * opaque);

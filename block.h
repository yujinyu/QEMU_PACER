...
void printDirtyOpInfoSet(BlockDriverState *bs);
void printWriteFreq(BlockDriverState *bs);
void printCountMap(BlockDriverState *bs);
...
void bdrv_info_history(Monitor *mon);
// End
...
int64_t bdrv_get_totallength(void); // Pacer Function for adaptive system
...
BlockDriverAIOCB *my_bdrv_aio_readv(BlockDriverState *bs, int64_t sector_num,
                                 QEMUIOVector *iov, int nb_sectors,
                                 BlockDriverCompletionFunc *cb, void *opaque);  // Pacer function for latency measurement
...
#define BDRV_SECTORS_PER_DIRTY_CHUNK_BIT 11
...
void bdrv_set_dirty(BlockDriverState *bs, int64_t cur_sector,
                      int nr_sectors); // Pacer function for adaptive system
...
void bdrv_set_write_throttling(BlockDriverState *bs, int enablei, int64_t transfer_rate);
